"""
DM_LCExtMemRead — KNX 03.05.02 §3.43 (PDF p. 168).
...
async def dm_lc_ext_mem_read(xknx: XKNX) -> None:
    """DM_LCExtMemRead — see module docstring for the verbatim spec text."""
    raise NotImplementedError(
        "DM_LCExtMemRead (KNX 03.05.02 §3.43) — implementation pending"
    )
