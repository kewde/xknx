"""
DMP_RunStateMachineVerify_RCo_Mem — KNX 03.05.02 §3.35.2 (PDF p. 153).
...
Spec text (verbatim from spec):
    ...
    sequenceDiagram
        ...
        Note right of S: A_Disconnect.ind ⇒ error, different state ⇒ error
    ```
...
async def dmp_run_state_machine_verify_r_co_mem(xknx: XKNX) -> None:
    """DMP_RunStateMachineVerify_RCo_Mem — see module docstring for the verbatim spec text."""
    raise NotImplementedError(
        "DMP_RunStateMachineVerify_RCo_Mem (KNX 03.05.02 §3.35.2) — implementation pending"
    )
