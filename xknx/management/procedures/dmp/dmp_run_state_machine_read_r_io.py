"""
DMP_RunStateMachineRead_R_IO — KNX 03.05.02 §3.36.3 (PDF p. 156).
...
async def dmp_run_state_machine_read_r_io(xknx: XKNX) -> None:
    """DMP_RunStateMachineRead_R_IO — see module docstring for the verbatim spec text."""
    raise NotImplementedError(
        "DMP_RunStateMachineRead_R_IO (KNX 03.05.02 §3.36.3) — implementation pending"
    )
