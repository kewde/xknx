"""
DMP_LCExtMemRead_Rco — KNX 03.05.02 §3.43.2 (PDF p. 169).
...
async def dmp_lc_ext_mem_read_rco(xknx: XKNX) -> None:
    """DMP_LCExtMemRead_Rco — see module docstring for the verbatim spec text."""
    raise NotImplementedError(
        "DMP_LCExtMemRead_Rco (KNX 03.05.02 §3.43.2) — implementation pending"
    )
