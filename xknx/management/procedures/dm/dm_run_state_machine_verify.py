"""
DM_RunStateMachineVerify — KNX 03.05.02 §3.35 (PDF p. 153).
...
async def dm_run_state_machine_verify(xknx: XKNX) -> None:
    """DM_RunStateMachineVerify — see module docstring for the verbatim spec text."""
    raise NotImplementedError(
        "DM_RunStateMachineVerify (KNX 03.05.02 §3.35) — implementation pending"
    )
