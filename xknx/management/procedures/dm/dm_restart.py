...
Spec text (verbatim from spec):
    ...
    02h        Factory Reset
                 ...
                 Channel Number:
                    ...
                    ≠ 00h: Only the Resources of the Channel with this given Channel Number shall
                               be reset.
    03h        ResetIA
                 The IA shall be reset to the medium specific default IA when this A_Restart is
                 executed.
                 Channel Number: Fixed: 00h
    04h        ResetAP
    ...
    09h to     The Management Client shall not use these Erase Codes.
    FFh        The Management Server shall on reception of an A_Restart-PDU with an Erase Code
               value in this range
    ...
    04h to      These values are reserved. The Management Server shall not use any value in this range.
    255h
    ...
    If the MaS performs a Master Reset, then the following shall apply.
     ...
     02h        Reset to default state               The MaS shall set the Authorisation Keys of the
                                                     ...
                                                     default” or a “Reset to default without IA” , then the MaS shall
     ...
     n.a.       Local Reset to default               See Erase Code 02h “Reset to default state”.
                state                                Additionally, the Authorisation Keys for the lower
    ...
    The Management Client shall send an A_Restart-PDU to the Mana-
    gement Server in point-to-point connectionless communication
