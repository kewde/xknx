"""
DM_LCExtMemVerify — KNX 03.05.02 §3.42 (PDF p. 167).
...
async def dm_lc_ext_mem_verify(xknx: XKNX) -> None:
    """DM_LCExtMemVerify — see module docstring for the verbatim spec text."""
    raise NotImplementedError(
        "DM_LCExtMemVerify (KNX 03.05.02 §3.42) — implementation pending"
    )
