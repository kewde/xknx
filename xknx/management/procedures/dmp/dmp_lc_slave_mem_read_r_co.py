"""
DMP_LCSlaveMemRead_RCo — KNX 03.05.02 §3.40.2 (PDF p. 164).
...
async def dmp_lc_slave_mem_read_r_co(xknx: XKNX) -> None:
    """DMP_LCSlaveMemRead_RCo — see module docstring for the verbatim spec text."""
    raise NotImplementedError(
        "DMP_LCSlaveMemRead_RCo (KNX 03.05.02 §3.40.2) — implementation pending"
    )
