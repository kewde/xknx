...
async def dm_interface_object_write(xknx: XKNX) -> None:
    """DM_InterfaceObjectWrite — see module docstring for the verbatim spec text."""
    raise NotImplementedError(
        "DM_InterfaceObjectWrite (KNX 03.05.02 §3.25) — implementation pending"
    )
