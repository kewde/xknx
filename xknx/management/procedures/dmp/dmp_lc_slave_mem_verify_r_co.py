"""
DMP_LCSlaveMemVerify_RCo — KNX 03.05.02 §3.39.2 (PDF p. 163).
...
async def dmp_lc_slave_mem_verify_r_co(xknx: XKNX) -> None:
    """DMP_LCSlaveMemVerify_RCo — see module docstring for the verbatim spec text."""
    raise NotImplementedError(
        "DMP_LCSlaveMemVerify_RCo (KNX 03.05.02 §3.39.2) — implementation pending"
    )
