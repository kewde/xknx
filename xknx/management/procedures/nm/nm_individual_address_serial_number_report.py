"""
NM_IndividualAddress_SerialNumber_Report — KNX 03.05.02 §2.22.4 (PDF p. 51).
...
Spec text (verbatim from spec):
    ...
    2.23.2 Overview of the accepted usage of A_NetworkParameter_Read
           (informative)
      •   NM_NetworkParameter_Read_R
          ...
          test_result:                not specified (abstract procedure)
            ...
            settings.
                    ...
                    Object Type                             test/value                    test_result
            R/W/T                 PID   req.   hc req                     res.   hc res
                                                                                                        Comment
           R        any           01    ?      ?        ?                 ?      ?        ?
