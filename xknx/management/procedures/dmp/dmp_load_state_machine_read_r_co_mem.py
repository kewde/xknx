"""
DMP_LoadStateMachineRead_RCo_Mem — KNX 03.05.02 §3.33.2 (PDF p. 146).
...
async def dmp_load_state_machine_read_r_co_mem(xknx: XKNX) -> None:
    """DMP_LoadStateMachineRead_RCo_Mem — see module docstring for the verbatim spec text."""
    raise NotImplementedError(
        "DMP_LoadStateMachineRead_RCo_Mem (KNX 03.05.02 §3.33.2) — implementation pending"
    )
